...
import com.czy.entity.QueryOrder;
...
public class WxPayController {
    ...
    public void init() {
        ...
        // 公众账号ID
        wxPayConfigStorage.setAppId("wxeca0dc53c1eaa5f1");
        // 合作者id（商户号）
        wxPayConfigStorage.setMchId("1632359723");
        //以下两个参数在 服务商版模式中必填--------
//        wxPayConfigStorage.setSubAppid("子商户公众账号ID ");
//        wxPayConfigStorage.setSubMchId("微信支付分配的子商户号 ");
        //-----------------------------------------------
        // 转账公钥，转账时必填
        wxPayConfigStorage.setKeyPublic(null);
        // 密钥
        wxPayConfigStorage.setSecretKey("lAoIH9F9mTv6pdDWhMKhICT17uwvc2d4");
        // 异步回调地址
        wxPayConfigStorage.setNotifyUrl("{base_url}/wx/payBackBefore.json");
        // 同步回调地址
        wxPayConfigStorage.setReturnUrl(null);
        // 签名方式
